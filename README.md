...
Репозиторий содержит spark_app, обучающий gbt классификатор для предсказания отмены бронирования отеля. Размер файла около 16 Mb, поэтому выбран размер блока в hadoop равный 32 Mb. Установлено ограничение памяти кластера в 20 Gb
